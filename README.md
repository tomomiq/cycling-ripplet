...
3. Open the HTML file and update the CONFIG section at the top:
   - Change the `<title>` tag to the ride name
   - Paste the full GPX file contents into `var GPX_DATA = \`...\``
   - Set `EXTRA_KM` if you missed the start (default `0`)
4. Commit and push — GitHub Pages publishes automatically
5. In Squarespace, add an Embed Block and paste:
   ```html
